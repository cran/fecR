...
Each fishing trip has the same departure and return dates and times and trip ID.
...
Each trip is defined by the start and return dates and times and has a unique identifier.
A trip entry with the same trip ID cannot have different dates and times.
